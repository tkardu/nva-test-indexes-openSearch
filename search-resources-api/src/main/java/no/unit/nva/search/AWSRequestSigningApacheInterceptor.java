...
public class AWSRequestSigningApacheInterceptor implements HttpRequestInterceptor {
    ...
    private static Map<String, List<String>> nvpToMapParams(final List<NameValuePair> params) {
        ...
        for (NameValuePair nvp : params) {
            List<String> argsList =
                    parameterMap.computeIfAbsent(nvp.getName(), k -> createList());
    ...
    private static Header[] mapToHeaderArray(final Map<String, String> mapHeaders) {
        ...
        for (Map.Entry<String, String> headerEntry : mapHeaders.entrySet()) {
            headers[i++] = createBasicHeader(headerEntry);
        }
        return headers;
    }

    private static BasicHeader createBasicHeader(Map.Entry<String, String> headerEntry) {
        return new BasicHeader(headerEntry.getKey(), headerEntry.getValue());
    }
}

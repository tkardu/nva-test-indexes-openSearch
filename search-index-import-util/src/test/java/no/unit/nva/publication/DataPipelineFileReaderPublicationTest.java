...
public class DataPipelineFileReaderPublicationTest {
    ...
    private static final String TOTAL_RECORDS_PROCESSED_MESSAGE =
            "Total number of records processed in this import is 44";
    ...
    private TestAppender createAppenderForLogMonitoring() {
        return LogUtils.getTestingAppender(DataPipelineFileReaderPublication.class);
    }
    ...
    void scanS3FolderLogsExportedRecordsWhenDynamodDBFileExportReaderIsCorrectlyConfigured() throws IOException {
        ...
        DataPipelineFileReaderPublication exportFileReader = new DataPipelineFileReaderPublication(mockS3Client);
    ...
    @Test
    void persistingPublicationHidesExceptionAndWritesLogWhenInputHasErrors() throws ImportException {
        initMocking();

        PublicationRestClient publicationRestClient = mock(PublicationRestClient.class);
        doThrow(ImportException.class).when(publicationRestClient).upsert(any());

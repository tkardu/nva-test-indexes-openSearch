...
public class ImportToPublicationHandler extends ApiGatewayHandler<ImportDataRequest, ImportDataCreateResponse> {
    ...
    @JacocoGenerated
    public ImportToPublicationHandler() {
     ...
     */
    public ImportToPublicationHandler(Environment environment) {
    ...
    public ImportToPublicationHandler(Environment environment,
                                      ...
                                      AmazonS3 s3Client) {
        super(ImportDataRequest.class, environment, LoggerFactory.getLogger(ImportToPublicationHandler.class));
